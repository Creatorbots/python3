...
#==============================================================================#
                    ...
                    try:
                        ...
                        ret_ += "\n╚══[ Dilarang Remake Tanpa Ijin Galank :v ]"
...
#==============================================================================#
                    ...
                    settings["copy"] = True
                    galank.sendMessage(to, "Kirim Contact Yang Mau Di Copy")
#==============================================================================#
                elif text.lower() == 'me':
                    ...
                    me = galank.getContact(galankMID)
                    cover = nadya.getProfileCoverURL(galankMID)    
...
#==============================================================================#
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            galank.sendMessage(to, "[ Group Ticket ]\nhttps://galank.me/R/ti/g/{}".format(str(ticket)))
                        else:
                    ...
                    if group.preventedJoinByTicket == True:
                        ...
                        gQr = "Terbuka"
                        gTicket = "https://galank.me/R/ti/g/{}".format(str(galank.reissueGroupTicket(group.id)))
                    path = "http://dl.profile.line-cdn.net/" + group.pictureStatus
                    ret_ = "╔══[ Group Info ]"
                        ...
                        for mention in mentionees:
                            if galankMID in mention["M"]:
                                if settings["detectMention"] == True:
                                    ...
                                    galank.sendMessage(to, "sundala nu")
